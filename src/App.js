...
//API KEY
const API_KEY = 'fb44831a30c91eacc41bd1424484d39c';
...
const App = () => {
  ...
  return ( 
  <div className = 'w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center bg-center flex flex-col items-center justify-center px-4 lg:px-0'>
    {errorMsg && (
      <div className = 'w-full max-w-[90wv] lg:max-w-[450px] bg-[#ff208c] text-white absolute top-2 lg:top-10 p-4 capitalize rounded-md'>{`${errorMsg.response.data.message}`}</div>
    )}
    {/* form */}
    <form 
